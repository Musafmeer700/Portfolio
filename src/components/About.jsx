...
const About = ({ darkMode }) => {
  const stats = [
    ...
    { label: "Experience", value: "1+ Year", delay: 650 },
        ...
        <article className="lg:pl-8 order-1 lg:order-2">
          <header data-aos="fade-up">
            ...
            <h2 className={`text-4xl lg:text-6xl font-extrabold mb-6 ${darkMode ? "text-white" : "text-gray-900"}`}>
              Engineering <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-400 to-orange-600">Digital Solutions</span>
            </h2>
          </header>
          ...
          <p
            ...
            data-aos-delay="500"
          >
            I am a Software Engineer and a recent graduate passionate about the 
            MERN stack. I specialize in building robust full-stack applications like 
            <span className="text-orange-500 font-medium"> FRESHSHOP</span> and 
            collaborative platforms like <span className="text-orange-500 font-medium"> SkillSwap</span>. 
            My focus is always on clean code and scalable architecture.
          </p>
